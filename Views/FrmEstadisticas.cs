...
{
    /// <summary>
    /// Represents a form for displaying and managing user statistics related to caloric intake and goals.
    /// </summary>
    /// <remarks>This form allows users to view daily and monthly statistics, including caloric consumption
    /// and goal fulfillment. It initializes with a default date range of the last 30 days and provides functionality to
    /// filter and display historical data.</remarks>
    public partial class FrmEstadisticas : Form
    {
        ...
        /// <summary>
        /// Initializes a new instance of the FrmEstadisticas form, configuring the user interface and setting default
        /// values for date and filter controls.
        /// </summary>
        /// <remarks>The form sets the date range to the last 30 days by default and initializes the month
        /// and year selectors to the current month and year. It also loads today's summary data upon
        /// initialization.</remarks>
        /// <param name="userName">The name of the user for whom the statistics will be displayed. Cannot be null or empty.</param>
        /// <param name="menuController">An instance of MenuController that manages menu-related interactions within the form. Cannot be null.</param>
        /// <param name="perfilController">An instance of PerfilController used to handle user profile operations within the form. Cannot be null.</param>
